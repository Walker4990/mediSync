...
const LoginForm = ({ onLoginSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.response) {
                ...
                if (status === 401) errorMessage = "아이디 또는 비밀번호가 올바르지 않습니다.";
    ...
    return (
        ...
        >
          ...
          ${isLoading ? "bg-blue-400" : "bg-blue-600 hover:bg-blue-700 active:scale-95"}
...
export default function Home() {
    ...
    bg-gradient-to-br from-blue-700 via-indigo-700 to-purple-700 text-white">
            ...
            >
                ...
                <p className="mt-3 text-gray-200">의료 · 보험 · 회계 통합 관리 시스템</p>
            </motion.div>
