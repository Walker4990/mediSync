...
public class MedicalRecordController {
    ...
    public MedicalRecord selectRecordDetailByMedicalId(@PathVariable("recordId") long recordId){
        return medicalRecordService.selectRecordDetailByRecordId(recordId);
    }
